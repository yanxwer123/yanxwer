...
public class NodeInfor extends AbsValueBean{
    ...
    private String nodeno_ownerdesc;
    ...
    public void setPhysicalnodeno(String physicalnodeno) {
        this.physicalnodeno = physicalnodeno;
    }
    ...
    public void setSinopecnodeno(String sinopecnodeno) {
        this.sinopecnodeno = sinopecnodeno;
    }
    ...
    public void setUsefulstatus(String usefulstatus) {
        this.usefulstatus = usefulstatus;
    }
    ...
    public String getNodeno_ownerdesc() {
        return nodeno_ownerdesc;
    }

    public void setNodeno_ownerdesc(String nodeno_ownerdesc) {
        this.nodeno_ownerdesc = nodeno_ownerdesc;
    }
