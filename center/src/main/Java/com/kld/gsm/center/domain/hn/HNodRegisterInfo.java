...
public class HNodRegisterInfo {
    ...
    private Integer beginentertype;
    ...
    public Integer getBeginentertype() {
        return beginentertype;
    }

    public void setBeginentertype(Integer beginentertype) {
        this.beginentertype = beginentertype;
    }

    public Integer getEndentertype() {
        return endentertype;
    }

    public void setEndentertype(Integer endentertype) {
