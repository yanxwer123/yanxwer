...
public class AlarmMeasureLeak extends AlarmMeasureLeakKey {
    ...
    public String toString() {
        return "AlarmMeasureLeak{" +
                "revealstatus='" + revealstatus + '\'' +
                ", revealrate='" + revealrate + '\'' +
                ", startoilheight=" + startoilheight +
                ", startwaterheight=" + startwaterheight +
                ", startoiltemp1=" + startoiltemp1 +
                ", startoiltemp2=" + startoiltemp2 +
                ", startoiltemp3=" + startoiltemp3 +
                ", startoiltemp4=" + startoiltemp4 +
                ", startoiltemp5=" + startoiltemp5 +
                ", enddate=" + enddate +
                ", endoilheight=" + endoilheight +
                ", endwaterheight=" + endwaterheight +
                ", endoiltemp1=" + endoiltemp1 +
                ", endoiltemp2=" + endoiltemp2 +
                ", endoiltemp3=" + endoiltemp3 +
                ", endoiltemp4=" + endoiltemp4 +
                ", endoiltemp5=" + endoiltemp5 +
                ", transtatus='" + transtatus + '\'' +
                ", shift='" + shift + '\'' +
                ", startoill=" + startoill +
                ", startwaterl=" + startwaterl +
                ", endoill=" + endoill +
                ", endwaterl=" + endwaterl +
                ", time=" + time +
                ", valid=" + valid +
