...
public class SysManageOilIn extends SysManageOilInKey {
    private String enddate;

    private String endtime;

    private Double startcubage;

    private Double startstandcubage;

    private Double startoilheight;

    private Double startwaterheight;

    private Double startoiltemp;
    ...
    private Double endcubage;

    private Double endstandcubage;

    private Double endoilheight;

    private Double endwaterheight;

    private Double endoiltemp;
    ...
    public void setStartstandcubage(Double startstandcubage) {
        this.startstandcubage = startstandcubage;
    }
    ...
    public void setEndstandcubage(Double endstandcubage) {
        this.endstandcubage = endstandcubage;
    }
